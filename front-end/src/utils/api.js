...
export async function makeReservations(reservation, signal) {
...
// Edit existing Reservation Info 

export async function editReservationInfo (reservation_id, reservation, signal) {
